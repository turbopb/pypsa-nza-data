...
#   Updated on Tue Sep 30 21:06:30 2025                                       *
#                                                                             *
...
if __name__ == '__main__':
    ...
    dirpath_list = [dirpath_export, dirpath_import, dirpath_gen, dirpath_g,
                    dirpath_bus, dirpath_demand, dirpath_f1f2,
                    dirpath_static]

    for dirpath in dirpath_list : ensure_directory_exists(dirpath, verbose = True)
    ...
    for _, dirpath in paths_dict.items(): ensure_directory_exists(dirpath, verbose = True)


    # Grid EXPORT and IMPORT - f1 & F2. Note that df_f2 and df_f1 are lists of
    # dataframes : df_f2[0] => df_f2("January"), df_f2[1] => df_f2("February")
