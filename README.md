...
Š
+-- loaders/|
Š   +-- nza_load_static_data_from_url.py|
Š   +-- nza_load_dynamic_data_from_url.py|
Š   +-- run_loader_pipeline.py|
Š
+-- processors/|
Š   +-- nza_process_static_data.py|
Š   +-- nza_process_dynamic_data.py|
Š   +-- nza_create_load_profile.py|
Š   +-- nza_convert_energy_to_power.py|
Š   +-- nza_modality_standard.py|
Š   +-- nza_transmission_line_processor.py|
Š   +-- run_process_data_pipeline.py|
Š   +-- helpers/|
Š       +-- nza_resample_timeseries.py|
Š       +-- nza_process_generator_data.py|
Š       +-- ...|
Š
+-- config/|
Š   +-- paths_and_settings.yaml|
Š
+-- README.md'''<pre>
