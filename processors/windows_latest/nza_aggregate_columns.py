...
def main():
    ...
    # Configuration
    input_dir = "C://Users/Public/Documents/Thesis/analysis/PYPSA-NZA/data/processed/TEST/gen/g_MWh/"
    output_dir = "C://Users/Public/Documents/Thesis/analysis/PYPSA-NZA/data/processed/TEST/export/cons_MWh_agg/"

    aggregation_type = "all"  # Options: 'poc', 'volts', 'unit', 'all'
    output_basename = "export_md_agg"
